...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	public void setCurrentItem(int item) {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			child.setPadding(20, 1, 2, 25);
			if (isSelected) {
				animateToTab(item);
				Drawable localDrawable2 = getResources().getDrawable(
						R.drawable.bl_home_line_01);
				Paint localPaint = new Paint();
				localPaint.setTextSize(((TextView) child).getTextSize());
				localDrawable2.setBounds(
						0,
						1,
						Float.valueOf(
								localPaint.measureText(((TextView) child)
										.getText().toString())).intValue(),
						localDrawable2.getMinimumHeight());
				((TextView) child).setCompoundDrawables(null, null, null,
						localDrawable2);
				...
				Drawable localDrawable1 = getResources().getDrawable(
						R.drawable.bl_home_line_01);
				localDrawable1.setBounds(0, 1,
						localDrawable1.getMinimumWidth(),
						localDrawable1.getMinimumHeight());
