...
import com.avicsafety.safety_examine.MyApplication;
import com.avicsafety.safety_examine.PowerManager.push.Utils.SharedUtils;
import com.avicsafety.safety_examine.PowerManager.push.service.PositionService;
...
//				    startServer();
	...
	public void login(final Context context, final String username, final String password, final String imei, final OnNetworkAccessToModelListener listener) {
		...
		RequestParams params = new RequestParams(com.avicsafety.safety_examine.conf.Constants.LOGIN);
			...
			public void onSuccess(String result) {
				...
				try {
					...
					if (code.equals("200")) {
						...
						com.avicsafety.safety_examine.conf.Constants.setUserInfo(context, datas);
						com.avicsafety.safety_examine.conf.Constants.setSubmitUser(username, context);
;
