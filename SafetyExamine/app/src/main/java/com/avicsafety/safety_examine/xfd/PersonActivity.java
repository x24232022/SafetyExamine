...
import com.avicsafety.safety_examine.adapter.PersonAdapter;
...
public class PersonActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAccoutn = com.avicsafety.safety_examine.yd.activity.ydUtil.Constants.getUserInfo(mActivity);
