 ...
 */
@ContentView(R.layout.yd_cl_photo_activity)
public class PhotoYdClActivity extends BaseActivity{
    ...
    private void SctpType1(){
        ...
        new CTCSRestClientUsage().dealSCTP(oThis,id,buffer.toString(),2);
...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        ...
        apl_company_detail_photo = (AvicPhotoList) findViewById(R.id.yd_hfsj_photo);
