package com.avicsafety.safety_examine.yd.activity.ydUtil;
...
import com.avicsafety.safety_examine.activity.FileScActivity;
import com.avicsafety.safety_examine.model.MUsers;
import com.avicsafety.safety_examine.model.Mdept;
import com.avicsafety.safety_examine.model.MgdxqN;
...
import com.avicsafety.safety_examine.yd.activity.GDDealWithMultiFildsActivity;
import com.avicsafety.safety_examine.yd.activity.GDDealWithOneFileActivity;
import com.avicsafety.safety_examine.yd.activity.GDGTDZActivity;
import com.avicsafety.safety_examine.yd.activity.GDShowAndDealWithNoFildActivity;
import com.avicsafety.safety_examine.yd.activity.MainActiitys;
import com.avicsafety.safety_examine.yd.activity.PhotoYdActivity;
import com.avicsafety.safety_examine.yd.activity.PhotoYdClActivity;
import com.avicsafety.safety_examine.yd.activity.ProcessedydActivity;
import com.avicsafety.safety_examine.yd.activity.RWList0Activity;
import com.avicsafety.safety_examine.yd.activity.RWList1Activity;
import com.avicsafety.safety_examine.yd.activity.UserListActivity;
...
public class CTCSRestClientUsage {
    ...
    public void dealSCTPDZ(final Context context, String id, String data,int type){
        ...
        RequestParams params = new RequestParams(com.avicsafety.safety_examine.conf.Constants.BASE_SCTP);
        params.addParameter("id",id);
        params.addParameter("submitUser", com.avicsafety.safety_examine.conf.Constants.getSubmitUser(context));
    ...
    public void dealSCWJ(final Context context, String id, String path,int type){
        ...
        RequestParams params = new RequestParams(com.avicsafety.safety_examine.conf.Constants.BASE_SCWJ);
