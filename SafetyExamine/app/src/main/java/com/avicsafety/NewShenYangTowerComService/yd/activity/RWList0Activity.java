...
public class RWList0Activity extends BaseActivity{
    ...
    public void initList(Mrwsl m){
        String[] tv_theme = { "待派发", "待处理", "待审核", "协同验证", "共同到站" ,"工单催办","催办反馈",
                            "工单督办","督办反馈"};
        ...
        for (int i = 0; i < 9; i++) {
            ...
            switch (i) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    map.put("tv_no",m.getReminders());
                    break;
                case 6:
                    map.put("tv_no",m.getRemindersBak());
                    break;
                case 7:
                    map.put("tv_no",m.getSupervise());
                    break;
                case 8:
                    map.put("tv_no",m.getSuperviseBak());
                    break;
            }
            listItems.add(map);
        }
