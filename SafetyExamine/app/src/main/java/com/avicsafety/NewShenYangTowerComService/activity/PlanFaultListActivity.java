...
//public class PlanFaultListActivity extends BaseActivity implements AdapterView.OnItemClickListener,AbPullToRefreshView.OnHeaderRefreshListener,AbPullToRefreshView.OnFooterLoadListener {
...
//    private String path= Constants.LOAD_FAULT_WORK;
//    private int type=2;
//
//
//    @Override
...
//        params.addParameter("status",type+"");
...
//        }
//        if(adapter==null){
//            adapter=new PowerAdapter(oThis, datas,2);
