...
public class MainActiitys extends BaseActivity {
        ...
        gv_main.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                switch (arg2) {
                    ...
                    case 1:
                        startActivity(new Intent(oThis, ProcessedydActivity.class));
                        break;
    ...
    private void initData() {
        ...
        try {
            new com.avicsafety.NewShenYangTowerComService.yd.activity.ydUtil.CTCSRestClientUsage().GetRWSL(oThis,0);
