...
import com.avicsafety.NewShenYangTowerComService.xfd.Rwsl;
import com.avicsafety.NewShenYangTowerComService.xfd.XinFDMethod;
import com.avicsafety.NewShenYangTowerComService.yd.activity.MainActiitys;
import com.avicsafety.NewShenYangTowerComService.yd.activity.ydUtil.Constants;
...
//                        manager.checkUpdate();
    ...
    public void initDatayd(){
        try {
            new com.avicsafety.NewShenYangTowerComService.yd.activity.ydUtil.CTCSRestClientUsage().GetRWSL(oThis,2);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
    public void initDatadx(){
        try {
            new com.avicsafety.NewShenYangTowerComService.dx.activity.dxUtil.CTCSRestClientUsage().GetRWSL(oThis,2);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
    public void initDatalt(){
        try {
            new com.avicsafety.NewShenYangTowerComService.lt.activity.ltUtil.CTCSRestClientUsage().GetRWSL(oThis,2);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
