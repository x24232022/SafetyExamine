...
import com.avicsafety.NewShenYangTowerComService.datedialog.DateTimePickerDialog;
...
public class GDGTDZActivity extends BaseActivity{
    ...
    @ViewInject(R.id.btn_yd_photo)
    private Button btn_yd_photo;
    ...
    protected void InitializeEvent() {
        ...
        btn_yd_photo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mActionSetting.setVisible(true);
                Intent intent = new Intent(oThis,PhotoYdActivity.class);
