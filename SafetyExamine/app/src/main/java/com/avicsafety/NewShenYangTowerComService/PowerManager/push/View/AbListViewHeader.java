 ...
 */
package com.avicsafety.NewShenYangTowerComService.PowerManager.push.View;
...
import com.avicsafety.NewShenYangTowerComService.PowerManager.push.Utils.DateUtils;
		...
		switch(state){
			case STATE_NORMAL:
				...
				if(lastRefreshTime==null){
					lastRefreshTime = DateUtils.getDateForString(new Date(), "HH:mm:ss");
