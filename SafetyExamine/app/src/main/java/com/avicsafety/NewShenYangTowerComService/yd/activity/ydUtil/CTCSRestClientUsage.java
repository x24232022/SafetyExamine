package com.avicsafety.NewShenYangTowerComService.yd.activity.ydUtil;
...
import com.avicsafety.NewShenYangTowerComService.activity.FileScActivity;
import com.avicsafety.NewShenYangTowerComService.model.MUsers;
import com.avicsafety.NewShenYangTowerComService.model.Mdept;
import com.avicsafety.NewShenYangTowerComService.model.MgdxqN;
import com.avicsafety.NewShenYangTowerComService.model.Mgroup;
import com.avicsafety.NewShenYangTowerComService.model.Mrwlb;
import com.avicsafety.NewShenYangTowerComService.model.Mrwsl;
import com.avicsafety.NewShenYangTowerComService.yd.activity.GDDealWithMultiFildsActivity;
import com.avicsafety.NewShenYangTowerComService.yd.activity.GDDealWithOneFileActivity;
import com.avicsafety.NewShenYangTowerComService.yd.activity.GDGTDZActivity;
import com.avicsafety.NewShenYangTowerComService.yd.activity.GDShowAndDealWithNoFildActivity;
import com.avicsafety.NewShenYangTowerComService.yd.activity.MainActiitys;
import com.avicsafety.NewShenYangTowerComService.yd.activity.PhotoYdActivity;
import com.avicsafety.NewShenYangTowerComService.yd.activity.PhotoYdClActivity;
import com.avicsafety.NewShenYangTowerComService.yd.activity.ProcessedydActivity;
import com.avicsafety.NewShenYangTowerComService.yd.activity.RWList0Activity;
import com.avicsafety.NewShenYangTowerComService.yd.activity.RWList1Activity;
import com.avicsafety.NewShenYangTowerComService.yd.activity.UserListActivity;
...
public class CTCSRestClientUsage {
    ...
    public void dealSCTPDZ(final Context context, String id, String data,int type){
        ...
        RequestParams params = new RequestParams(com.avicsafety.NewShenYangTowerComService.conf.Constants.BASE_SCTP);
        params.addParameter("id",id);
        params.addParameter("submitUser", com.avicsafety.NewShenYangTowerComService.conf.Constants.getSubmitUser(context));
    ...
    public void dealSCWJ(final Context context, String id, String path,int type){
        ...
        RequestParams params = new RequestParams(com.avicsafety.NewShenYangTowerComService.conf.Constants.BASE_SCWJ);
