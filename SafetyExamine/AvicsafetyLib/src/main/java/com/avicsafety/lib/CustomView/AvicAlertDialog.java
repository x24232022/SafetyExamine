...
public class AvicAlertDialog {
    ...
    public AvicAlertDialog(final Context context, int icon ,String message, int type) {
        ...
        ImageView imageView = (ImageView) view.findViewById(R.id.customAlert_title_icon);
        imageView.setImageResource(icon);
        TextView textView = (TextView) view.findViewById(R.id.customAlert_message);
        ...
        //只有一个按键的Dialog
        if (type == 1) {
            dialog.setButton(android.app.AlertDialog.BUTTON_POSITIVE, "确认", new DialogInterface.OnClickListener() {
                @Override
            ...
            if (okListener == null) {
                positive.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        okListener.PositiveButton(v,"确认");
                        dialog.dismiss();
                    }
                });
            }
            ...
            if (interceptEvent == null) {
                positive.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        interceptEvent.PositiveButton(v,"确认");
                        dialog.dismiss();
                    }
                });
