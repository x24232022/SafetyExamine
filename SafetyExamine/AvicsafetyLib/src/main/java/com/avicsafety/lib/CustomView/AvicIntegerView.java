...
public class AvicIntegerView extends RelativeLayout implements I_kv{
...
//	private int max_count;
	...
	public AvicIntegerView(Context context, AttributeSet attrs) {
		super(context, attrs);
        ...
        btn_com_avicsafety_lib_number_increase.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				if(view_value.getText().toString().length()==0){
					...
					view_value.setText(Integer.valueOf(view_value.getText().toString())+1+"");
				}
			}});
